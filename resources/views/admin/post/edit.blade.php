            ...
            <form method="post" action="{{ route('admin.post.update', $post) }}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="title" name="title"
                        value="{{ old('title', $post->title) }}" placeholder="Enter title ..." required autofocus>
                </div>
                ...
                <div class="form-group">
                    ...
                    <img src="{{ $post->image }}" alt="" width="100" height="100" class="mt-2">
                </div>
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" id="summary" name="summary" placeholder="summary ..." rows="3" required
                        autofocus>{{ old('summary', $post->summary) }}</textarea>
                </div>
